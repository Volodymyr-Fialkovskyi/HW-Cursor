...
class Main {
    public static void main(String[] args) {
        ...
        listShape.add(new Triangle(2, 2, 4, 3, 6, 1));
        listShape.add(new Rectangle(2, 2, 3, 6));
        listShape.add(new Circle(2, 5, 7));

        listShape.add(new SquarePyramid(3, 5, 6, 7, 10));
        listShape.add(new Cuboid(1, 4, 6, 4, 6, 5));
        listShape.add(new Sphere(2, 1, 1, 8));
